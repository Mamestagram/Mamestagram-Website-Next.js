...
export default function LeaderboardScopeSwitch({
	mode,
	sortBy,
	countries,
	country,
	...
	const preferredCountry = userInfo.isLoggedIn
		? userInfo.country?.trim().toLowerCase()
		: undefined;
	...
	return (
		<nav
			...
			data-country-menu-open={isCountryMenuOpen}
			data-page-enter="box"
		...
		>
			<Link
				...
				className={classNames({
					[styles.selected_scope]: selectedScope === "global",
				})}
			>
			...
			<button
				...
				className={classNames({
					[styles.selected_scope]: selectedScope === "country",
				})}
			...
			<Link
				...
				className={classNames({
					[styles.selected_scope]: selectedScope === "clans",
				})}
			>
					...
					<div className={styles.country_ranking_options}>
						{countryOptions.map((option) => (
							<Link
								...
								className={classNames({
									[styles.selected_country]: country === option.code,
								})}
