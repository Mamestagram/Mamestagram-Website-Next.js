					...
					<>
						<div className={styles.field}>
							...
							{state.errors.username &&
								<p id="username-error" className={styles.field_error}>{state.errors.username}</p>}
						</div>
						<div className={styles.field}>
							...
							<input id="email"
							       ...
							       required/>
							{state.errors.email &&
								<p id="email-error" className={styles.field_error}>{state.errors.email}</p>}
						</div>
					...
					<>
						<div className={styles.field}>
							...
							<input id="login"
							       ...
							       required/>
							{state.errors.login &&
								<p id="login-error" className={styles.field_error}>{state.errors.login}</p>}
						</div>
						<PasswordField name="password"
						               label="Password"
						               error={state.errors.password}
